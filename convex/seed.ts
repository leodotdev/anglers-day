...
export const clearAll = internalMutation({
  args: {},
  handler: async (ctx) => {
    const tables = ["messages", "conversations", "reviews", "bookings", "availability", "listings", "boats", "users"] as const;
...
export const seed = internalMutation({
  ...
  handler: async (ctx) => {
    ...
    const listing1 = await ctx.db.insert("listings", {
      ...
      departurePort: "Miami Beach Marina, Dock C-12",
      departureLatitude: 25.7781,
      departureLongitude: -80.1322,
      departureCity: "Miami",
      departureState: "FL",
    ...
    const listing3 = await ctx.db.insert("listings", {
      ...
      departureLatitude: 24.5594,
      departureLongitude: -81.8050,
    ...
    const listing4 = await ctx.db.insert("listings", {
      ...
      departurePort: "Haulover Marina, North Miami",
      departureLatitude: 25.9049,
      departureLongitude: -80.1228,
      departureCity: "Miami",
      departureState: "FL",
      includesEquipment: true,
      includesBait: true,
    ...
    const listing5 = await ctx.db.insert("listings", {
      ...
      departurePort: "Islamorada Marina, MM 80",
      departureLatitude: 24.9243,
      departureLongitude: -80.6274,
    ...
    const listing6 = await ctx.db.insert("listings", {
      ...
      departurePort: "Stock Island Marina, Key West",
      departureLatitude: 24.5700,
      departureLongitude: -81.7350,
      departureCity: "Key West",
      departureState: "FL",
      includesEquipment: true,
      includesBait: true,
    ...
    const listing8 = await ctx.db.insert("listings", {
      ...
      departurePort: "Marathon City Marina, MM 49",
      departureLatitude: 24.7136,
      departureLongitude: -81.0955,
    ...
    const listing9 = await ctx.db.insert("listings", {
      ...
      departurePort: "Coconut Grove Marina, Miami",
      departureLatitude: 25.7285,
      departureLongitude: -80.2358,
      departureCity: "Miami",
      departureState: "FL",
      includesEquipment: true,
      includesBait: true,
    ...
    const listing10 = await ctx.db.insert("listings", {
      ...
      departurePort: "Matheson Hammock Marina",
      departureLatitude: 25.6805,
      departureLongitude: -80.2536,
      departureCity: "Coral Gables",
      departureState: "FL",
      includesEquipment: true,
      includesBait: true,
      includesLunch: false,
    ...
    const listing12 = await ctx.db.insert("listings", {
      ...
      departurePort: "Lighthouse Point Marina",
      departureLatitude: 26.2772,
      departureLongitude: -80.0822,
      departureCity: "Lighthouse Point",
      departureState: "FL",
      includesEquipment: true,
      includesBait: true,
      includesLunch: true,
    ...
    const listing13 = await ctx.db.insert("listings", {
      ...
      departurePort: "Garrison Bight Marina, Key West",
      departureLatitude: 24.5636,
      departureLongitude: -81.7838,
      departureCity: "Key West",
      departureState: "FL",
      includesEquipment: true,
      includesBait: true,
    ...
    const listing15 = await ctx.db.insert("listings", {
      ...
      departurePort: "Geiger Key Marina, MM 10",
      departureLatitude: 24.5914,
      departureLongitude: -81.6561,
    ...
    const listing16 = await ctx.db.insert("listings", {
      ...
      departurePort: "Dinner Key Marina, Coconut Grove",
      departureLatitude: 25.7263,
      departureLongitude: -80.2371,
      departureCity: "Miami",
      departureState: "FL",
      includesEquipment: true,
      includesBait: true,
